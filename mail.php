...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$cmessage = $_REQUEST['company'];
	$prayer = $_REQUEST['message'];
...
$body = "<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><title>MAIL FROM FCI</title></head><body>";
	...
	$body .= "<tr><td></td></tr>";
	$body .= "<tr><td colspan='2' style='border:none;'><strong>Company Name:</strong></td></tr>";
	$body .= "<tr><td colspan='2' style='border:none;'>{$cmessage}</td></tr>";
	$body .= "<tr><td colspan='2' style='border:none;'><strong>Message:</strong></td></tr>";
	$body .= "<tr><td colspan='2' style='border:none;'>{$prayer}</td></tr>";
	$body .= "</tbody></table>";
	$body .= "</body></html>";
